    ...
    <div class="row">
      ...
      <div class="col-lg-9 ms-paper-content-container">
        <div class="ms-paper-content">
          <h1>Ekstraksi Fitur | LOWERCASE</h1>
              ...
              <div class="col-md-12">
                ...
                <div class="card">
                  <div class="card-block">
                    <form id="form-allcaps">
                      <input type="hidden" name="page" value="lowercase">
...
$("#form-allcaps").submit(function(e) {
    e.preventDefault();
