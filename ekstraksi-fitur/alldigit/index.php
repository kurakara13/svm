    ...
    <div class="row">
      ...
      <div class="col-lg-9 ms-paper-content-container">
        <div class="ms-paper-content">
          <h1>Ekstraksi Fitur | ALLDIGIT</h1>
              ...
              <div class="col-md-12">
                ...
                <div class="card">
                  <div class="card-block">
                    <form id="form-alldigit">
                      <input type="hidden" name="page" value="alldigit">
...
$("#form-alldigit").submit(function(e) {
    e.preventDefault();
