    ...
    <div class="row">
      ...
      <div class="col-lg-9 ms-paper-content-container">
        <div class="ms-paper-content">
          <h1>Ekstraksi Fitur | CONTAINSDOTS</h1>
              ...
              <div class="col-md-12">
                ...
                <div class="card">
                  <div class="card-block">
                    <form id="form-containsdots">
                      <input type="hidden" name="page" value="containsdots">
...
$("#form-containsdots").submit(function(e) {
    e.preventDefault();
